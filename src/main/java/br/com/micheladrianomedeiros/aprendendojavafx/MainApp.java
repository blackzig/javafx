package br.com.micheladrianomedeiros.aprendendojavafx;

import br.com.micheladrianomedeiros.aprendendojavafx.tools.ResizeImage;
import java.io.File;
...
//        File file = new File("src/main/resources/img/Earthrise_Apollo_11.jpg");
//        if(file.exists()){
//            System.out.println("YES");
//        }else{
//            System.out.println("NO");
//        }
//        ResizeImage.returnImageResize(file.getAbsolutePath(), 516, 387);
...
// Provides the animated scrolling behavior for the text
        ...
        Image image = new Image("img/Earthrise_Apollo_11.jpg");
